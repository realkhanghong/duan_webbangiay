                    ...
                    <div class="list-group">
                        <div class="list-group-item list-group-item-action">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input custom-control-input-primary custom-control-input-outline cat_all" type="checkbox" id="cat_all" <?= !is_array($category_ids) && $category_ids =='all' ?  : "" ?>>
                                <label for="cat_all" class="custom-control-label"> Tất cả sản phẩm</label>
                            </div>
                        </div>
                        <?php 
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        ...
                        <div class="row" id="product_list">
                            ...
                            ?>
                            <div class="col-lg-4 col-md-6 col-sm-12 prod-item">
                                <a href="./?page=products/view_product&id=<?= $row['id'] ?>" class="card rounded-0 text-reset text-decoration-none">
                                <div class="prod-img-holder position-relative">
                                    <img src="<?= validate_image($row['image_path']) ?>" alt="prod-image" class="prod-img">
                                </div>
                                    <div class="card-body border-top border-gray">
                                        <h5 class="text-center card-title text-truncate w-100"><?= $row['name'] ?></h5> <br>
                                        ...
                                        <div class="d-flex">
                                            <div class="col-auto px-0"><small class="text-muted">Thương hiệu: </small></div>
                                        ...
                                        <div class="d-flex w-100">
                                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1 text-center"><p class="m-0 pl-3"><h5 class="text-danger"><?= format_num($row['price']) ?> ₫</h5></p></div>
                                        </div>
