...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./login.php" class="h5"><b>ĐĂNG NHẬP NHÂN VIÊN</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Nhập thông tin để đăng nhập</p>

      <form id="salogin-frm" action="" method="post">
...
<script>
  $(function(){
    ...
    $('#salogin-frm').submit(function(e){
        ...
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Login.php?f=login_sales_agent",
