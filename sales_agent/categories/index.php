...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h5 class="card-title"><b>Danh sách các danh mục</b></h5>
			<div class="card-tools">
			<a href="javascript:void(0)" class="btn btn-normal btn-primary" id="create_new"><span class="fas fa-plus"></span>  Tạo danh mục mới</a>
		</div>
        </div>
	<div class="card-body">
