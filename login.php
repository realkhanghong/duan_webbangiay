...
<body class="hold-transition login-page">
  <script>
    start_loader()
    <?php unset($_SESSION['login_type']); unset($_SESSION['access_token']);?>
  </script>
  <style>
      body{
          width:calc(100%);
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
        ...
        <?php
              ...
              include 'facebook/facebook_source.php';
        ?>
    <div class="card-header text-center">
      <a href="./login.php" class="h5"><b>ĐĂNG NHẬP KHÁCH HÀNG</b></a>
    </div>
    <div class="card-body">
      ...
      <form id="cclogin-frm" action="" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" autofocus placeholder="Tài khoản">
        ...
        <div class="row align-item-end">
          ...
          <div class="col-12 text-center">
            <a href="<?= $loginUrl ?>" class="btn btn-block bg-gradient-success">Hoặc Đăng nhập bằng Facebook</a>
          </div>
          <br></br>
          <div class="col-12 text-center">
          <a href="<?= base_url.'./register.php' ?>" class="btn btn-block bg-gradient-warning"> Chưa có tài khoản, Đăng Ký</a>
          </div>
