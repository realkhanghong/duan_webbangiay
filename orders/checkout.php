<div class="content py-3">
    <div class="card card-outline card-primary shadow rounded-0">
        ...
        <h5 class=""><b>Tiến hành Thanh toán</b></h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-8">
                    <form action="" id="checkout-form">
                        ...
                        <div class="form-group text-right">
                            <button class="btn btn-flat btn-default btn-sm bg-navy">Đặt hàng ngay</button>
                        </div>
                    </form>
                    <?php 
                    $gtotal = 0;
                    ...
                    $tongtien_vnd = $gtotal;
                    ?>
                    <form class="" method="POST" target="_blank" enctpye="application/x-www-form-urlencoded"
                                        action= "/orders/xulythanhtoanmomo.php">
                    ...
                    <p></p>
                    <form class="" method="POST" target="_blank" enctpye="application/x-www-form-urlencoded"
                                        action= "/orders/xulythanhtoanmomo_atm.php">
                        <input type="hidden" value="<?php echo $tongtien_vnd ?>" name="tongtien_vnd">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-12 border">
                        <h2 class="text-center"><b>Đơn giá</b></h2>
                    </div>
...
<script>
    $('#checkout-form').submit(function(e){
        ...
        if($('#summary .item').length <= 0){
            alert_toast("Không có đơn hàng nào được trong giỏ hàng.",'error')
            return false;
        }
        $('.pop_msg').remove();
        var el = $('<div>')
