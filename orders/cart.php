...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow-0">
        <div class="card-header">
            <h5 class=""><b>Danh sách Giỏ hàng</b></h5>
        </div>
        <div class="card-body">
            <div id="cart-list">
                <div class="row">
                ...
                ?>
                    <div class="col-12 border">
                        <span><b><?= $vrow['code']. " - " . $vrow['shop_name'] ?></b></span>
                    </div>
                    <div class="col-12 border p-0">
                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-3 text-right">Tổng số tiền: <?= format_num($total) ?></div>
                        </div>
                        <?php endwhile; ?>
                    </div>
                    <div class="col-12 border">
                        <div class="d-flex">
                            <div class="col-9 text-right font-weight-bold text-dark">Tổng tiền hàng</div>
                ...
                <?php endwhile; ?>
                    <div class="col-12 border">
                        <div class="d-flex">
                            <div class="col-9 h4 font-weight-bold text-right text-dark">Tổng thanh toán</div>
    ...
    <div class="text-right">
        <a href="./?page=orders/checkout" class="btn btn-danger btn-sm"> Thanh toán ngay</a>
    </div>
</div>
<script>
    $(function(){
        ...
        _conf("Bạn có muốn xóa sản phẩm này khỏi danh sách giỏ hàng không?",'delete_cart',[$(this).attr('data-id')])
        })
    })
