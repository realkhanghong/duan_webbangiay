...
<div class="container-fluid">
    ...
    <?php 
        ...
        <div class="col-12 border">
            <div class="d-flex">
                <div class="col-9 h4 font-weight-bold text-right text-muted">Tổng tiền</div>
	...
	<div class="text-right">
        <?php if(isset($status) && $status == 0): ?>
		    <button class="btn btn-default bg-gradient-danger text-light btn-sm btn-flat" type="button" id="cancel_order">Hủy đặt hàng</button>
        <?php endif; ?>
...
<script>
    $(function(){
        $('#cancel_order').click(function(){
            _conf("Bạn có muốn hủy đơn đặt hàng này không?","cancel_order",['<?= isset($id) ? $id : '' ?>'])
        })
    })
