  ...
  <div class="d-flex justify-content-center align-items-center flex-row">
        ...
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline col-12 rounded-0 shadow">
                    <div class="card-body">
                    <h4><b><span>ĐĂNG KÝ TÀI KHOẢN KHÁCH HÀNG</span></b></h4>
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="middlename" name="middlename" class="form-control form-control-sm form-control-border" placeholder="Có thể bỏ trống">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" id="email" name="email" class="form-control form-control-sm form-control-border" placeholder="Dùng làm tài khoản đăng nhập" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="row align-item-end">
                            <div class="col-6">
                                <a href="<?= base_url ?>" class="btn btn-block bg-gradient-dark">Quay lại</a>
                            </div>
                            <!-- /.col -->
                            <div class="col-6">
                                <button type="submit" class="btn btn-block bg-gradient-warning">Đăng ký</button>
                            </div>
                            <br></br>
                            <div class="col-12 text-center">
                            <a href="<?= base_url.'./login.php' ?>" class="btn btn-block bg-gradient-info">Đã có tài khoản, Đăng Nhập</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
