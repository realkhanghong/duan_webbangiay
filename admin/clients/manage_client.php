				...
				<form action="" id="manage-user">	
					...
					<div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="middlename" name="middlename" class="form-control form-control-sm form-control-border" value="<?= isset($middlename) ? $middlename : "" ?>" placeholder="có thể bỏ trống">
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" id="email" name="email" class="form-control form-control-sm form-control-border" placeholder="Dùng làm tài khoản đăng nhập" value="<?= isset($email) ? $email : "" ?>" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
						...
						<small class="text-muted"><i>Để trống nếu bạn không muốn thay đổi mật khẩu.</i></small>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
