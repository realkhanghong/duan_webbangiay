...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"><b>Danh sách khách hàng</b></h3>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT *,CONCAT(firstname,' ', COALESCE(middlename),' ',lastname) as `name` from `client_list` where delete_flag = 0 order by CONCAT(firstname,' ', COALESCE(middlename),' ',lastname) asc ");
