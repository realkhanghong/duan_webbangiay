...
<div class="content">
	<div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h5 class="card-title"><b>Danh sách các sản phẩm</b></h5>
			<div class="card-tools">
			<a href="javascript:void(0)" class="btn btn-normal btn-primary" id="create_new"><span class="fas fa-plus"></span>  Thêm sản phẩm mới</a>
		</div>
    </div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-center"><img src="<?= validate_image($row['image_path']) ?>" alt="Product Image" class="product-img"></td>
							<td>
							...
							<td class="text-center">
                                ...
                                <?php else: ?>
                                    <span class="badge badge-danger bg-gradient-danger px-3 rounded-pill">Chưa kích hoạt</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
