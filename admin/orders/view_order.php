...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-9 border"><span class="font-weight-bolder">
            ...
            $status = isset($status) ? $status : '';
                switch($status){
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        echo '<span class="badge badge-danger bg-gradient-danger px-3 rounded-pill">Đã bị hủy</span>';
                        break;
                    default:
            ...
            ?>
            <?php if($status != 5): ?>
                <span class="pl-2"><a href="javascript:void(0)" id="update_status">Cập nhật trạng thái đơn hàng</a></span>
            <?php endif; ?>
        </div>
    </div>
