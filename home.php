...
<div class="col-lg-12 py-5">
    <div class="contain-fluid">
        ...
        <div class="clear-fix mb-3"></div>
                    ...
                    <h3 class="text-center"><b>Các sản phẩm mới</b></h3>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 prod-item">
                ...
                <div class="prod-img-holder position-relative">
                    <img src="<?= validate_image($row['image_path']) ?>" alt="Product-image" class="img-top prod-img">
                </div>
                    ...
                    -->
                        ...
                        <div class="d-flex">
                            ...
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-primary"><?= format_num($row['price']) ?>&nbspđ</small></p></div>
                        </div>
        ...
        <div class="text-center">
            <a href="./?page=products" class="btn btn-large btn-primary rounded-pill col-lg-3 col-md-5 col-sm-12">Khám phá các sản phẩm khác</a>
        </div>
    </div>
</div>